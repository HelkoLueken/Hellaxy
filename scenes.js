...
scene.credits.events = function() {
	...
	Game.ctx.fillText("Concept : HelkoLueken",100,200);
	Game.ctx.fillText("Characters : HelkoLueken, TheKaramboli",100,300);
	Game.ctx.fillText("Artwork : HelkoLueken, TheKaramboli",100,400);
	Game.ctx.fillText("Programming : HelkoLueken, SoerenDaenekas",100,500);
