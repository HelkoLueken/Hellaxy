...
sector.testmap.setup = function(){
	...
	spawnShip("Humanian Shuttle", 300, 100, 0, "test");
	spawnShip("Humanian Shuttle", 400, 100, 0, "none");
	spawnShip("Testarrow", 100, 100, 0, "none");
	spawnShip("Testarrow", 100, 300, 180, "simpleRoamer");
...
scene.credits.events = function() {
	...
	Game.ctx.fillText("Concept : HelkoLeucken",100,200);
	Game.ctx.fillText("Characters : HelkoLeucken, TheKaramboli",100,300);
	Game.ctx.fillText("Artwork : HelkoLeucken, TheKaramboli",100,400);
	Game.ctx.fillText("Programming : HelkoLeucken, SoerenDaenekas",100,500);
